      ...
      appBar: PreferredSize(
          child: AppBar(
            ...
            title: GestureDetector(
              child: SearchWidget(),
              onTap: (){
                SearchHotKeyModel searchHotKeyModel = SearchHotKeyModel(type: "HOME");
                showSearch(context: context, delegate: DefaultSearchDelegate(type: "HOME",searchHotKeyModel: searchHotKeyModel)); //HOME 首页进入；COLUMN 名师进入
              },
            ),
          ),
